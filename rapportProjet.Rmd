...
## Modèle 3 : four predictors (gender, partyid, hhinc, poleffic)


Pour ce dernier modèle, nous faisons un modèle de régression multiple avec les quatres variables explicatives qui ont été trouvé associées à notre variable d'intérêt dans le modèle 2 :  $\mathtt{gender, hhinc, partyid, poleffic, polinffreq}$.
